...
# Set page config
st.set_page_config(
    page_title="Multi-Collection RAG System",
    page_icon="🤖",
    layout="wide",
...
if 'current_page' not in st.session_state:
    st.session_state.current_page = "Enhanced RAG Chat"
...
def main():
    ...
    if st.session_state.current_page == "Enhanced RAG Chat":
